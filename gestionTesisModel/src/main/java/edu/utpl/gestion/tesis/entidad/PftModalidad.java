...
@XmlRootElement(name = "modalidades")
@NamedQueries({
    @NamedQuery(name = "PftModalidad.findAll", query = "SELECT p FROM PftModalidad p"),
    @NamedQuery(name = "PftModalidad.findByModId", query = "SELECT p FROM PftModalidad p WHERE p.modId = :modId"),
    @NamedQuery(name = "PftModalidad.findByModCodigo", query = "SELECT p FROM PftModalidad p WHERE p.modCodigo = :modCodigo"),
    @NamedQuery(name = "PftModalidad.findByModNombre", query = "SELECT p FROM PftModalidad p WHERE p.modNombre = :modNombre")})
public class PftModalidad implements Serializable {
    ...
    public String toString() {
        return "edu.utpl.soa.tesis.entidades.PftModalidad[ modId=" + modId + " ]";
    }
